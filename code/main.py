...
os.system(f"python3 train.py --data dota_1_5.yaml --workers 0 --cfg ./models/yolov5s__spd_conv__eca_net__bifpn.yaml --batch-size 64 --epochs 100 --sync-bn --project yolov5s__spd_conv__eca_net --name yolov5s__spd_conv__eca_net --hyp hyp.scratch_s.yaml")